...
SECRET_KEY = "django-insecure-@*0y#2w@b0kx(@l%f%k)_@l0l1nc+7^lowi&1qqy7v+6-dl+*2"
...
STATICFILES_DIRS = [  
    os.path.join(BASE_DIR, 'cafeteria/static'),  # Add your app's static directory
]
...
LOGIN_URL = '/admin/login/'  # Redirects unauthenticated users to the admin login page