...
model.load_state_dict(torch.load(f"./trained_model/train{trainidx}.pth"))
...
for batch_idx in range(1,5):
    image_dir   = f"./object_classification_batch_{batch_idx}/"
    label_path  = f"./object_classification_batch_{batch_idx}.csv"
...
torch.save(model.state_dict(), f"./trained_model/train{trainidx+1}.pth")